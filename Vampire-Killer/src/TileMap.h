...
enum class Tile {
	...
	//id >= 60: ground
	BLOCK_GROUND = 60, BLOCK_CASTLE_DIRT, BLOCK_CASTLE_DIRT2, BLOCK_INVISIBLE,
	...
	CASTLE18 = 137, CASTLE19, CASTLELADDER1, CASTLELADDER2, CASTLELADDERTOP,

	ITEM_FIRE_HEART = 140, ITEM_FIRE_HEART_BIG, ITEM_FIRE_WHIPE, ITEM_CANDLE_HEART, ITEM_CANDLE_HEART_BIG, ITEM_CANDLE_BLUE_ORB, ITEM_CANDLE_RED_ORB,
	ITEM_CANDLE_RING, ITEM_CANDLE_KEY,
	

	ENEMY_KNIGHT = 200, ENEMY_MEDUSA_HEAD_LEFT, ENEMY_MEDUSA_HEAD_RIGHT, ENEMY_BAT, ENEMY_BATINTRO_RIGHT, ENEMY_BATINTRO_LEFT,
